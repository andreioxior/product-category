...
class ProductController extends Controller
{
    ...
    {
        $cacheKey = 'api_products_'.md5(serialize($request->all()));
    ...
    public function featured(Request $request): JsonResponse
    {
        ...
        $cacheKey = "api_featured_products_{$limit}";

        $products = Cache::remember($cacheKey, now()->addMinutes(15), function () use ($limit) {
