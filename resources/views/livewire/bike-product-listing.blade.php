        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8">
            <div class="max-w-7xl mx-auto">
                <div class="flex items-center gap-4 mb-6">
                    @php
                        $breadcrumbs = [
                            ['label' => $bike->manufacturer, 'url' => route('bikes.manufacturer', ['manufacturer' => strtolower($bike->manufacturer)])],
                            ['label' => $bike->model, 'url' => route('bikes.model', ['manufacturer' => strtolower($bike->manufacturer), 'model' => str_replace(' ', '-', strtolower($bike->model))])],
                            ['label' => $bike->year]
                        ];
                    @endphp
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        >
                            @foreach ($sortOptions as $key => $label)
                                <button
                                    @click="open = false; $wire.set('sort', '{{ $key }}')"
                ...
                @if ($filteredProducts->count() === 0)
                    <div class="text-center py-12">
                        ...
                        <flux:text class="text-zinc-500 dark:text-zinc-400 mb-4">
                            There are no products available for this bike.
                        </flux:text>
